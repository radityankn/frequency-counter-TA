...
create_clock -name measure_signal_i -period 100.000 [get_ports measure_signal_i]

create_clock -add -name clk_i -period 20.000 -waveform {0.000 10.000} [get_ports clk_i_ext]
